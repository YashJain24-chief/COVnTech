...
public class WorldActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<dataFormat>> {

    public static final String LOG_TAG = WorldActivity.class.getName();
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (world_list.contains(query)) {
                    ...
                    Toast.makeText(WorldActivity.this, "No Match found", Toast.LENGTH_LONG).show();
                }
                return false;
            }
    ...
    public Loader<List<dataFormat>> onCreateLoader(int id, Bundle args) {
        return new worldLoader(this, world_query_url);
    }
